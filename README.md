# ☸️ Cluster Lab: Orquestación de Kubernetes con Kubespray
...
[Image of Kubernetes cluster architecture showing Master and Worker nodes]
...
[Image of Ansible workflow orchestrating deployment across multiple nodes]
...
```bash
# Ejecución del despliegue del clúster
